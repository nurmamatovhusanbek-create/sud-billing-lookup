import os, time
os.environ["CHROME_BINARY"] = "/home/z/.cache/puppeteer/chrome/linux-150.0.7871.24/chrome-linux64/chrome"

from seleniumbase import SB

print("Starting SeleniumBase UC mode...")
with SB(uc=True, headless=False, binary_location="/home/z/.cache/puppeteer/chrome/linux-150.0.7871.24/chrome-linux64/chrome") as sb:
